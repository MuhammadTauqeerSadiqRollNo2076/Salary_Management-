...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2023 at 07:28 PM
...
CREATE TABLE `entities` (
  `salary item` int(11) NOT NULL,
  `basic_sallary` int(11) NOT NULL,
  `allowance` int(10) NOT NULL,
  `overtime_pay` int(9) NOT NULL,
  `bonuses` int(12) NOT NULL,
  `Commission` int(5) NOT NULL,
  `Benefits` int(1) NOT NULL,
  `Incentive` int(3) NOT NULL,
  `Salary configration template` int(11) NOT NULL,
  `job_grade_structure` int(11) NOT NULL,
  `pay_structure` int(11) NOT NULL,
  `allowance_structure` int(11) NOT NULL,
  `bonus_and_incentive_structure` int(11) NOT NULL,
  `benefits_structure` int(11) NOT NULL,
  `tax_and_statutory_deduction` int(11) NOT NULL,
  `Attach Configration Template to Employee` int(11) NOT NULL,
  `basicinformation` varchar(200) NOT NULL,
  `compensation` int(100) NOT NULL,
  `deduction` int(110) NOT NULL,
  `leave_and_attendance` varchar(13) NOT NULL,
  `benefit` int(14) NOT NULL,
  `payroll_processing` varchar(15) NOT NULL,
  `compliance` varchar(16) NOT NULL,
  `Salary Reporting` int(11) NOT NULL,
  `payroll_summary_report` int(11) NOT NULL,
  `employee_summary_report` int(11) NOT NULL,
  `compliance_report` int(11) NOT NULL,
  `benefits_report` int(11) NOT NULL,
  `salary_trend_report` int(11) NOT NULL,
  `cost_projection_report` int(11) NOT NULL
